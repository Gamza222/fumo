...
function AnalyticsExample() {
  return (
    <div className={styles.card}>
      ...
      >
        This page demonstrates the analytics tracking system. Events are
        automatically tracked when you navigate here.
      </Text>

      <div className={styles.analyticsCard}>
        <Text variant={TextVariant.PRIMARY} size={TextSize.LG}>
          📊 Analytics System Active - Check monitoring dashboard for tracked
          events
        </Text>
      </div>
    </div>
